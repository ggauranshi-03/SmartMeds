...
contract Record {
    ...
    function updateAppointment(
        ...
        require(
            isDoctor[msg.sender],
            "Only a registered doctor can update an appointment"
        );
        Appointments storage a = appointments[_addr];
    ...
    {
        require(
            isApproved[_address][msg.sender],
            "You are not authorized to access this patient's demographic data."
        );
        ...
        )
    {
        require(
            isApproved[_address][msg.sender],
            "You are not authorized to access this patient's medical data."
        );
    ...
    {
        require(isDoctor[_address], "You are not a registered doctor.");
